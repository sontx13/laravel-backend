...
<script>
    ...
    function DrawKetQuaHoTroHuongDanMotCua() {
        ...
        $.ajax({
            type: 'post',
            url: '/admin/ketqua-hotro-huongdan-motcua-06',
            data: {
                "_token": "{{ csrf_token() }}",
            ...
            success: function(response) {
                hideLoading();
                $("#content-ketqua-hotro-huongdan-motcua").html(response);
            },
            error: function(err) {
                console.log(err);
                hideLoading();
    ...
    function ShowModalThemMoiKetQuaHoTroHuongDanMotCua() {
        ...
        $("#themoiKetQuaHoTroHuongDanMotCuaModal").modal('show');
    ...
    function ThemMoiKetQuaHoTroHuongDanMotCua() {
        ...
        $.ajax({
            type: 'post',
            url: '/admin/ketqua-hotro-huongdan-motcua-06/them-moi',
            data: {
                "_token": "{{ csrf_token() }}",
    ...
    function ShowModalSuaKetQuaHoTroHuongDanMotCua(id) {
        $.ajax({
            type: 'post',
            url: '/admin/ketqua-hotro-huongdan-motcua-06/sua-modal',
            data: {
                id: id
            },
            success: function(response) {
    ...
    function CapNhatKetQuaHoTroHuongDanMotCua(id) {
        ...
        $.ajax({
            type: 'post',
            url: '/admin/ketqua-hotro-huongdan-motcua-06/cap-nhat',
            data: {
                "_token": "{{ csrf_token() }}",
                id: id,
                tenxaphuong: params.tenxaphuong,
        ...
        swal("Bạn có chắc chắn muốn xóa bản ghi?", {
            ...
            .then((value) => {
                if (value) {
                    ...
                    $.ajax({
                        type: 'post',
                        url: '/admin/ketqua-hotro-huongdan-motcua-06/xoa',
                        data: {
                            id: id
                        },
                        success: function(response) {
