            ...
            <div class="row select-baocao">
                ...
                <div class="col-sm-6" hidden>
                    <select id="cbx-baocao" class="select2" onchange="OnChangeBaoCao()">
                        ...
                        <option value="9" selected>VII. ĐƠN THƯ KHIẾU NẠI, TỐ CÁO</option>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#export-btn').click(function() {
                console.log(1)
                var wb = XLSX.utils.table_to_book(document.getElementById('exportContent9'), {
                    sheet: 'Sheet JS'
                });
                XLSX.writeFile(wb, 'Donthu_khieunai_tocao.xlsx');
            });
        });
