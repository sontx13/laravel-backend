            ...
            <div class="row select-baocao">
                ...
                <div class="col-sm-6" hidden>
                    <select id="cbx-baocao" class="select2" onchange="OnChangeBaoCao()">
                        ...
                        <option value="7" selected>V. KẾT QUẢ HOẠT ĐỘNG CỦA BAN THANH TRA NHÂN DÂN</option>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#export-btn').click(function() {
                console.log(1)
                var wb = XLSX.utils.table_to_book(document.getElementById('exportContent7'), {
                    sheet: 'Sheet JS'
                });
                XLSX.writeFile(wb, 'Banthanhtra_nhandan.xlsx');
            });
        });
