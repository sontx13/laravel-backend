            ...
            <div class="row select-baocao">
                ...
                <div class="col-sm-6" hidden>
                    <select id="cbx-baocao" class="select2" onchange="OnChangeBaoCao()">
                        ...
                        <option value="10" selected>VIII. KẾT QUẢ TỔ CHỨC HỌP THÔN, BẢN, TỔ DÂN PHỐ</option>
                    </select>
                </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#export-btn').click(function() {
                console.log(1)
                var wb = XLSX.utils.table_to_book(document.getElementById('exportContent10'), {
                    sheet: 'Sheet JS'
                });
                XLSX.writeFile(wb, 'hoptodanpho.xlsx');
            });
        });
