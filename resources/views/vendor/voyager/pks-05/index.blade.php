                    ...
                    <div class="col-sm-3" id="donviXa" style="display:none">
                        <select id="cbx-donvi" class="select2" onchange="OnChangeDonVi()">
                            @if ($donvi_id > 12){
                                ...
                                @endforeach
                            @endif
                            @if ($donvi_id < 13){ @foreach ($donvis as $donvi)
                                    <option value="{{ $donvi->id }}">{{ $donvi->ten_donvi }}</option>
                                @endforeach
                            @endif
...
@section('javascript')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            // Ngày bắt đầu là ngày đầu tháng của ngày hiện tại
            var fromDate = currentDate.startOf('month').format('YYYY-MM-DD');

            // Ngày kết thúc là ngày cuối tháng của ngày hiện tại
            var toDate = currentDate.endOf('month').format('YYYY-MM-DD');
