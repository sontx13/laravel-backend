        ...
        <div class="row tilte-huyen">
            ...
            <div class="col-sm-5 center margin-30">
                <h4 class="title" style="font-size:17px !important;">
                    KQ HĐ CỦA BAN GIÁM SÁT ĐẦU TƯ CỦA CỘNG ĐỒNG
                </h4>
                <h4 class="title" style="font-size:17px !important;">
            ...
            <div class="row select-baocao">
                ...
                <div class="col-sm-6" hidden>
                    <select id="cbx-baocao" class="select2" onchange="OnChangeBaoCao()">
                        ...
                        <option value="2">II. KQ HĐ CỦA BAN GIÁM SÁT ĐẦU TƯ CỦA CỘNG ĐỒNG</option>
                        ...
                        <option value="8" selected>VI. KẾT QUẢ HOẠT ĐỘNG CỦA BAN GIÁM SÁT ĐẦU TƯ CỦA CỘNG ĐỒNG</option>
