            ...
            <div class="row select-baocao">
                ...
                <div class="col-sm-6" hidden>
                    <select id="cbx-baocao" class="select2" onchange="OnChangeBaoCao()">
                        ...
                        <option value="4" selected>III. NHÂN DÂN THAM GIA Ý KIẾN</option>
...
@section('javascript')
    ...
    <script>
        ...
        $(document).ready(function() {
            OnChangeDonVi();
            $("#txt-kehoach-4").change(function() {
                UploadFile();
            });
            $("#txt-duthao-4").change(function() {
                UploadFile3();
            });
            $("#txt-baocao-4").change(function() {
                UploadFile2();
            });
            $('.check-ykien').on('change', function() {
                if ($(this).is(':checked')) {
