        ...
        <div class="row tilte-huyen">
            ...
            <div class="col-sm-5 center margin-30">
                <h4 class="title" style="font-size:17px !important;">
                    KHẢO SÁT LẤY Ý KIẾN CỦA CÁN BỘ, CÔNG CHỨC VỀ THỰC HIỆN QUY CHẾ DÂN CHỦ Ở CƠ QUAN XÃ, PHƯỜNG, THỊ TRẤN
                </h4>
                <h4 class="title" style="font-size:17px !important;">
                    NĂM {{ $currentYear }}
                </h4>
...
@section('content')
    <div class="baocao">
        ...
        <div id="modal-sua-PKS01">
        </div>
        @include('voyager::pks-01.modal-themmoi')
    </div>
@stop

@include('voyager::pks-01.include')
<link rel="stylesheet" href="/css/style.css">
@section('javascript')
