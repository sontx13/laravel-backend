        ...
        <div class="row tilte-huyen">
            ...
            <div class="col-sm-5 center margin-30">
                <h4 class="title" style="font-size:17px !important;">
                    TỔNG HỢP KẾT QUẢ KHẢO SÁT LẤY Ý KIẾN CỦA CÁN BỘ, CÔNG CHỨC VỀ THỰC HIỆN QUY CHẾ DÂN CHỦ Ở CƠ QUAN XÃ, PHƯỜNG, THỊ TRẤN
                </h4>
                <h4 class="title" style="font-size:17px !important;">
                    NĂM {{ $currentYear }}
                </h4>
        ...
        <div>
            <form method="get" class="form-search">
                <div class="row select-baocao">
                    ...
                    <div class="col-sm-3">
                        <div class="date-index"> <input class="form-control" type="date" value={{ $fromDate }}
                    ...
                    <div class="col-sm-3">
                        <div class="date-index"> <input class="form-control" value={{ $toDate }} type="date"
