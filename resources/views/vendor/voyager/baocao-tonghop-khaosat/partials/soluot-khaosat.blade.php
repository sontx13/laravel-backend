  ...
  <div class="row">
    <div class="col-sm-12">
        ...
        <div class="text-center">
            <h4 class="title-table-report">BẢNG TỔNG HỢP LƯỢT KHẢO SÁT</h4>
        </div>
        <table class="table table-boder table-hover table2excel">
            <thead>
                ...
                <th>Tên huyện</th>
                <th class="text-center" width="200">Tổng số lượt đánh giá</th>
                </tr>
            </thead>
        ...
        $(".exportToExcel").click(function(e){
            ...
            if(table && table.length){
                ...
                $(table).table2excel({
                    ...
                    filename: "TonghopSoluotKS_" + new Date().toISOString().replace(/[\-\:\.]/g, "") + ".xls",
                    fileext: ".xls",
                    exclude_img: true,
                    exclude_links: true,
                    exclude_inputs: true,
