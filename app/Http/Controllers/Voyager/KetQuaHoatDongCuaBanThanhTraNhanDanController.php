...
class KetQuaHoatDongCuaBanThanhTraNhanDanController extends VoyagerBaseController
{
    ...
    public function KetQuaHoatDongCuaBanThanhTraNhanDan(Request $request)
    {
        ...
        $view = 'voyager::nhaplieu-baocao.partials.ketqua-hoatdong-cuabanthanhtra-nhandan.danh-sach';
    ...
    public function ThemMoiKetQuaHoatDongCuaBanThanhTraNhanDan(Request $request)
    {
        ...
        try {
            DB::table('ketqua_hoatdong_cuabanthanhtra_nhandan')->insert([
                ...
                'xulykhac_vetien' => str_replace(',', '', $xulykhacvetien),
