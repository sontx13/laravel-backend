...
class XemKetQuaHoatDongCuaBanGiamSatDauTuCuaCongDongController extends VoyagerBaseController
{
    ...
    public function KetQuaHoatDongCuaBanGiamSatDauTuCuaCongDong(Request $request)
    {
        ...
        $view = 'voyager::xem-nhaplieu-baocao-webview.partials.ketqua-hoatdong-cuabangiamsatdautu-cuacongdong.danh-sach';
