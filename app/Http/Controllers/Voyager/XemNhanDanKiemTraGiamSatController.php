...
class XemNhanDanKiemTraGiamSatController extends VoyagerBaseController
{
    ...
    public function NhanDanKiemTraGiamSat(Request $request) {
        ...
        $view = 'voyager::xem-nhaplieu-baocao-webview.partials.nhandan-kiemtra-giamsat.danh-sach';
        return Voyager::view($view, compact('lsNhanDanKiemTraGiamSats'));
    }
