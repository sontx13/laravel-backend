...
class KetQuaToChucHopThonBanToDanPhoController extends VoyagerBaseController
{
    ...
    public function KetQuaToChucHopThonBanToDanPho(Request $request)
    {
        ...
        $view = 'voyager::nhaplieu-baocao.partials.ketqua-tochuchop-thonban-todanpho.danh-sach';
        $isxembaocao = $request->isxembaocao;
        return Voyager::view($view, compact('lsKetQuaToChucHops', 'isxembaocao', 'tenHuyen'));
    }
