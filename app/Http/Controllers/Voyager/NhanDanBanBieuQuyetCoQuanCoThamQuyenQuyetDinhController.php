...
class NhanDanBanBieuQuyetCoQuanCoThamQuyenQuyetDinhController extends VoyagerBaseController
{
    ...
    public function NhanDanBanBieuQuyetCoQuanCoThamQuyenQuyetDinh(Request $request)
    {
        ...
        $view = 'voyager::nhaplieu-baocao.partials.nhandan-ban-bieuquyet-coquan-cothamquyen-quyetdinh.danh-sach';
        $isxembaocao = $request->isxembaocao;
        return Voyager::view($view, compact('lsNhanDanBanVaCoQuanQuyetDinhs', 'isxembaocao','tenHuyen'));
    }
