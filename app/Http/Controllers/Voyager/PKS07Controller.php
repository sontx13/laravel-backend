...
class PKS07Controller extends VoyagerBaseController
{
    ...
    public function ThemMoiKetQuaHoTroHuongDanMotCua(Request $request)
    {
        ...
        DB::beginTransaction();
        try {
            DB::table('ketqua_hotro_huongdan_motcua_pks07')->insert([
    ...
    public function CapNhatKetQuaHoTroHuongDanMotCua(Request $request)
    {
        ...
        DB::beginTransaction();
        try {
            DB::table('ketqua_hotro_huongdan_motcua_pks07')
                ->where('id', $id)
                ->update([
                    'so_luong' => $soluot,
