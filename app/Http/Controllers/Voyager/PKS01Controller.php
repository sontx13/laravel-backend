...
class PKS01Controller extends VoyagerBaseController
{
    ...
    public function KetQuaHoTroHuongDanMotCua(Request $request)
    {
        ...
        $lsKetQua = $queryFinal->orderBy('so_luong')->get();
    ...
    public function ThemMoiKetQuaHoTroHuongDanMotCua(Request $request)
    {
        ...
        DB::beginTransaction();
        try {
            DB::table('ketqua_hotro_huongdan_motcua_pks01')->insert([
                'ten_xaphuong' => $tenxaphuong,
                'so_luong' => $soluot, // số lượt người dân làm thủ tục
    ...
    public function CapNhatKetQuaHoTroHuongDanMotCua(Request $request)
    {
        ...
        DB::beginTransaction();
        try {
            DB::table('ketqua_hotro_huongdan_motcua_pks01')
                ->where('id', $id)
                ->update([
                    'so_luong' => $soluot,
